...
export default function Sidedrawer({ showSidedrawer, setShowSideDrawer}) {
  ...
  return (
    <div
      className={`flexd w-1/5  bg-gray-800 rounded-lg  p-2  text-white fixed h-full ease-in-out duration-100 ${
